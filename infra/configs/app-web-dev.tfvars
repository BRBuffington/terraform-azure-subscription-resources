subscription_id = "baae704a-5e1a-44f9-acff-0e2d0af61e3f" # IT-Web-Public-DEV
...
vnets = {
  ...
  "vnet-webcms-si-eus2" = {
    ...
    address_space       = ["172.24.24.0/23"]
    tags                = { "EnvironmentType" = "si" }
    dns_servers         = ["172.28.128.196"] # Use Azure-Native DNS, will be switched to Private Resolvers once that's ready

    subnets = {
      "PrivateLink" = {
        address_cidr                                   = "172.24.24.0/27"
        enforce_private_link_service_network_policies  = true
        enforce_private_link_endpoint_network_policies = true
      }

      "Acgcom" = {
        address_cidr = "172.24.24.32/27"
      }

      "Gicom" = {
        address_cidr = "172.24.24.64/27"
      }

      "Gpcom" = {
        address_cidr = "172.24.24.96/27"
      }

      "Gpjp" = {
        address_cidr = "172.24.24.128/27"
      }

      "Gscom" = {
        address_cidr = "172.24.24.160/27"
      }

      "InvInfocom" = {
        address_cidr = "172.24.24.192/27"
      }

      "VM" = {
        address_cidr      = "172.24.24.224/27"
  ...
  "vnet-webcms-si-cus" = {
    ...
    address_space       = ["172.25.24.0/23"]
    tags                = { "EnvironmentType" = "si" }
    dns_servers         = ["172.28.129.196"]

    subnets = {
      "PrivateLink" = {
        address_cidr                                   = "172.25.24.0/27"
        enforce_private_link_service_network_policies  = true
        enforce_private_link_endpoint_network_policies = true
      }

      "Acgcom" = {
        address_cidr = "172.25.24.32/27"
      }

      "Gicom" = {
        address_cidr = "172.25.24.64/27"
      }

      "Gpcom" = {
        address_cidr = "172.25.24.96/27"
      }

      "Gpjp" = {
        address_cidr = "172.25.24.128/27"
      }

      "Gscom" = {
        address_cidr = "172.25.24.160/27"
      }

      "InvInfocom" = {
        address_cidr = "172.25.24.192/27"
      }

      "VM" = {
        address_cidr      = "172.25.24.224/27"
        service_endpoints = ["Microsoft.AzureActiveDirectory"]
        attach_nsg        = false #NSG attached with Web-Sites-CMSVM deployment
      }
    }
...
azure_provider_monitoringstore = {
  ...
  region_alias           = "eus2"
  region                 = "eastus2"
  environment_type_alias = "dev"
  suffix                 = "infra"
  landingzone_key        = "Online"
  landingzone_alias      = "web"
}
monitoring = {
  monitor_activity_log_alert = {
    mala01 = {
      ...
      scopes = [
        "/subscriptions/baae704a-5e1a-44f9-acff-0e2d0af61e3f" # IT-Web-Public-DEV
