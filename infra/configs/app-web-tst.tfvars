...
vnets = {
  ...
  "vnet-webcms-qa-eus2" = {
    ...
    address_space       = ["172.24.22.0/23"]
    tags                = { "EnvironmentType" = "qa" }
    dns_servers         = ["172.28.128.196"]

    subnets = {
      "PrivateLink" = {
        address_cidr                                   = "172.24.22.0/27"
        enforce_private_link_service_network_policies  = true
        enforce_private_link_endpoint_network_policies = true
      }

      "Acgcom" = {
        address_cidr = "172.24.22.32/27"
      }

      "Gicom" = {
        address_cidr = "172.24.22.64/27"
      }

      "Gpcom" = {
        address_cidr = "172.24.22.96/27"
      }

      "Gpjp" = {
        address_cidr = "172.24.22.128/27"
      }

      "Gscom" = {
        address_cidr = "172.24.22.160/27"
      }

      "InvInfocom" = {
        address_cidr = "172.24.22.192/27"
      }

      "VM" = {
        address_cidr      = "172.24.22.224/27"
  ...
  "vnet-webcms-qa-cus" = {
    ...
    address_space       = ["172.25.22.0/23"]
    tags                = { "EnvironmentType" = "qa" }
    dns_servers         = ["172.28.129.196"]

    subnets = {
      "PrivateLink" = {
        address_cidr                                   = "172.25.22.0/27"
        enforce_private_link_service_network_policies  = true
        enforce_private_link_endpoint_network_policies = true
      }

      "Acgcom" = {
        address_cidr = "172.25.22.32/27"
      }

      "Gicom" = {
        address_cidr = "172.25.22.64/27"
      }

      "Gpcom" = {
        address_cidr = "172.25.22.96/27"
      }

      "Gpjp" = {
        address_cidr = "172.25.22.128/27"
      }

      "Gscom" = {
        address_cidr = "172.25.22.160/27"
      }

      "InvInfocom" = {
        address_cidr = "172.25.22.192/27"
      }

      "VM" = {
        address_cidr      = "172.25.22.224/27"
        service_endpoints = ["Microsoft.AzureActiveDirectory"]
        attach_nsg        = false #NSG attached with Web-Sites-CMSVM deployment
      }
    }
