...
vnets = {
  ...
  "vnet-mdmadf-qa-eus2" = {
    ...
    address_space       = ["172.24.13.0/24"]
    tags                = { "EnvironmentType" = "qa" }

    subnets = {
      "Functions" = {
        address_cidr      = "172.24.13.0/26"
  ...
  "vnet-mdmadf-qa2-eus2" = {
    location            = "eastus2"
    resource_group_name = "rg-network-eus2"
    address_space       = ["172.24.11.0/24"]
    tags                = { "EnvironmentType" = "qa" }

    subnets = {
      "Functions" = {
        address_cidr      = "172.24.11.0/26"
        service_endpoints = ["Microsoft.Storage", "Microsoft.KeyVault", "Microsoft.Sql", "Microsoft.Web"]
  ...
  "vnet-mdmdata-tst-eus2" = {
    location            = "eastus2"
    resource_group_name = "rg-network-eus2"
    address_space       = ["172.24.1.0/24"]
    tags                = { "EnvironmentType" = "tst" }
    dns_servers         = ["172.28.128.196"]

    subnets = {
      "VirtualDataGateway" = {
        address_cidr      = "172.24.1.0/26"
      ...
      "VM" = {
        address_cidr = "172.24.1.64/26"
      }
      "Endpoints" = {
        address_cidr                                   = "172.24.1.128/25"
        enforce_private_link_service_network_policies  = true
        enforce_private_link_endpoint_network_policies = true
      }
    }
