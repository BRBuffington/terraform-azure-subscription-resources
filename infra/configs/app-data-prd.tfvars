subscription_id = "00000000-0000-0000-0000-000000000000" # GI-MDM-Data-PRD
...
monitoring = {
  monitor_activity_log_alert = {
    mala01 = {
      ...
      scopes = [
        "/subscriptions/00000000-0000-0000-0000-000000000000" # GI-MDM-Data-PRD
  ...
  monitor_metric_alert = {
    ...
    mma02 = {
      ...
      action = {
        action_group = {
          id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/RG-ACDBA-PRD/providers/microsoft.insights/actionGroups/AG-DBA-Support"
        }
      }
      tags = {
        "EnvironmentType"       = "prd"
